...
/*   Updated: 2019/01/14 17:30:53 by jmartel          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int			u_basic5(void)
{
	...
	dprintf(2, "precision:%.5lu\n", nb);
	dprintf(2, "Prec + 0:%0.5lu\n", nb);
	dprintf(2, "Prec + minus:%-.5lu\n", nb);
	dprintf(2, "size:%5lu\n", nb);
	dprintf(2, "size + minus:%-5lu\n", nb);
	dprintf(2, "size + 0:%05lu\n", nb);
	dprintf(2, "size + 0 + prec:%05.3lu\n", nb);
	dprintf(2, "size + minus + prec:%-5.3lu\n", nb);
	dprintf(2, "%-5.3lu\n", nb);
	dprintf(2, "%050.lu\n", nb);
	dprintf(2, "%-1.45lu\n", nb);
	dprintf(2, "%-55.35lu\n", nb);
